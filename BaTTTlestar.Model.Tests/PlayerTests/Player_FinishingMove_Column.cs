...
namespace BaTTTlestar.Model.Tests.PlayerTests
{
    ...
    public class Player_FinishingMove_Column
    {
        ...
        public void Test_Player_Column0_Row0(IPlayer player, int value)
        {
            var board = new Board();
        ...
        [Test, TestCaseSource("TestValues")]
        public void Test_Player_Column0_Row1(IPlayer player, int value)
        {
            var board = new Board();
        ...
        [Test, TestCaseSource("TestValues")]
        public void Test_Player_Column0_Row2(IPlayer player, int value)
        {
            var board = new Board();
        ...
        [Test, TestCaseSource("TestValues")]
        public void Test_Player_Column1_Row0(IPlayer player, int value)
        {
            var board = new Board();
        ...
        [Test, TestCaseSource("TestValues")]
        public void Test_Player_Column1_Row1(IPlayer player, int value)
        {
            var board = new Board();
        ...
        [Test, TestCaseSource("TestValues")]
        public void Test_Player_Column1_Row2(IPlayer player, int value)
        {
            var board = new Board();
        ...
        [Test, TestCaseSource("TestValues")]
        public void Test_Player_Column2_Row0(IPlayer player, int value)
        {
            var board = new Board();
            board.AddMove(new Move(0, 0), 1);
            board.AddMove(new Move(0, 1), 1);
        ...
        [Test, TestCaseSource("TestValues")]
        public void Test_Player_Column2_Row1(IPlayer player, int value)
        {
            var board = new Board();
            board.AddMove(new Move(1, 0), 1);
            board.AddMove(new Move(1, 1), 1);
        ...
        [Test, TestCaseSource("TestValues")]
        public void Test_Player_Column2_Row2(IPlayer player, int value)
        {
            var board = new Board();
            board.AddMove(new Move(2, 0), 1);
            board.AddMove(new Move(2, 1), 1);
